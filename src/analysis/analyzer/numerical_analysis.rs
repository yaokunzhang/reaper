    ...
    for NumericalAnalysis<'tcx, 'a, 'compiler>
{
        ...
        ApronAbstractDomain<DomainType>: GetManagerTrait,
    {
        ...
        let mut body_visitor = BodyVisitor::new(self.context, def_id, abstract_domain, 0, vec![]);
        body_visitor.init_promote_constants();
        body_visitor.run();
        ...
        debug!(
            ...
            body_visitor.buffered_diagnostics.len(),
            func_name
        );
