...
use crate::analysis::ownership::ownership_domain::OwnershipDomain;
    ...
    ApronAbstractDomain<DomainType>: GetManagerTrait,
{
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(
            f,
            "numerical: {:?}, symbolic: {:?}, ownership: {:?}",
            self.numerical_domain, self.symbolic_domain, self.ownership_domain
        )
    }
}
    ...
    ApronAbstractDomain<DomainType>: GetManagerTrait,
{
    ...
    pub fn default() -> Self {
        Self {
            ...
            ownership_domain: OwnershipDomain::default(),
    ...
    pub fn get_paths_iter(&self) -> Vec<Rc<Path>> {
        ...
        // let o = self.ownership_domain.get_paths_iter();
    ...
    pub fn remove(&mut self, path: &Rc<Path>) {
        ...
        self.ownership_domain.forget(path);
    }
    ...
    pub fn rename(&mut self, old_path: &Rc<Path>, new_path: &Rc<Path>) {
        ...
        self.ownership_domain.rename(old_path, new_path);
    }
    ...
    pub fn duplicate(&mut self, old_path: &Rc<Path>, new_path: &Rc<Path>) {
        ...
        self.ownership_domain.duplicate(old_path, new_path);
    }
    ...
    pub fn ownership_states_at(&self, path: &Rc<Path>) -> HashSet<OwnershipState> {
        self.ownership_domain.get_states(path)
    }

    pub fn update_ownership_state_at(&mut self, path: Rc<Path>, state: HashSet<OwnershipState>) {
        self.ownership_domain.state_map.insert(path, state);
    }
    ...
    pub fn join(&self, other: &Self) -> Self {
        ...
        let ownership = self.ownership_domain.lub(&other.ownership_domain);
        Self {
            numerical_domain: numerical,
            symbolic_domain: symbolic,
            ownership_domain: ownership,
            exit_conditions: HashMap::new(),
        }
    }
    ...
    pub fn meet(&self, other: &Self) -> Self {
        ...
        Self {
            ...
            ownership_domain: other.ownership_domain.clone(),
            exit_conditions: HashMap::new(),
        }
    }
    ...
    pub fn widening_with(&self, other: &Self) -> Self {
        ...
        let ownership = self.ownership_domain.widening_with(&other.ownership_domain);
        Self {
            numerical_domain: numerical,
            symbolic_domain: symbolic,
            ownership_domain: ownership,
