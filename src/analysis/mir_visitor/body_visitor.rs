...
pub struct BodyVisitor<'tcx, 'a, 'compilation, DomainType>
where
...
impl<'tcx, 'a, 'compilation, DomainType> BodyVisitor<'tcx, 'a, 'compilation, DomainType>
where
    DomainType: ApronDomainType,
    ApronAbstractDomain<DomainType>: GetManagerTrait,
{
        ...
        ApronAbstractDomain<DomainType>: GetManagerTrait,
    {
            ...
            .enumerate()
        {
            ...
            let mut wto_visitor = BodyVisitor::new(
                self.context,
                self.def_id,
...
impl<'tcx, 'a, 'compilation, DomainType> WtoVisitor
    for BodyVisitor<'tcx, 'a, 'compilation, DomainType>
where
    DomainType: ApronDomainType,
    ApronAbstractDomain<DomainType>: GetManagerTrait,
{
